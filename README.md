...
[`Desktop icons (light & dark)`][realfavicongenerator] 🎁

[`iOS touch icons`][realfavicongenerator] 🎁

[`Web app manifest`][realfavicongenerator] 🎁

[`Android icons`][realfavicongenerator] 🎁

[`Windows tile icons`][realfavicongenerator] 🎁
...
- [`@realfavicongenerator/generate-favicon`](HTTPS://NPMJS.Org/@realfavicongenerator/generate-favicon)
...
[`Source/Interface/Option.ts`](HTTPS://GitHub.Com/PlayForm/Favicon/blob/main/Source/Interface/Option.ts)
